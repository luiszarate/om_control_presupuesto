...
class ImagoBudgetReportService(models.AbstractModel):
    ...
    def get_report(self, budget, cutoff_month, category=None):
        ...
        line_domain = [
            ...
            ("order_id.date_planned", ">=", fields.Datetime.to_string(start_utc)),
            ("order_id.date_planned", "<", fields.Datetime.to_string(end_utc)),
        ]
        ...
        for line in purchase_lines:
            order = line.order_id
            month = self._month_in_timezone(order.date_planned, budget.timezone)
            ...
            detail = {
                ...
                "confirmation_date": fields.Datetime.to_string(order.date_planned),
                "month": month,
